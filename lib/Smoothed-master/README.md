...
*  a simple linear recursive exponential filterHeading
...
2.  Add a Savitzky Golay filterHeading.
3.  Add a running median filterHeading. Best method to eliminate random spikes in an otherwise stable signal. Need to work out how to handle different data types. Rounding maybe??
